...
class ReminderCompletedPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final completedReminders = context
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          Strings.reminderCompletedTitle,
      ...
      body: completedReminders.isEmpty
          ? const Center(
              child: Text(
                Strings.reminderCompletedEmptyContent,
                style: TextStyle(
                  ...
                  endActionPane: ActionPane(
                    ...
                    children: [
                              ...
                              .addReminderFromCompleted(
                                reminder.copyWith(
                                  ...
                                  remindEndTime: DateTime.now()
                                      .add(
                                        Duration(
                                          milliseconds: reminder.remindTime,
                                        ),
                                      )
                      ...
                      SlidableAction(
                        ...
                        // 分到更多空间
                        onPressed: (_) {
                          context.read<ReminderViewModel>().removeReminder(
                            reminder,
                          );
                        },
