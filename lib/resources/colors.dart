...
class AppColors {
  ...
  static const Color commonGreenMid = Color(0xFF02BC6A);
  static const Color commonGreenMidNext = Color(0xFF7BC5AE);
  static const Color commonGreenMidNextLight = Color(0xFFD1EDE1);
  static const Color commonYellow = Color(0xFFFADB88);
